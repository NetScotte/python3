...
@pass_context
def main(ctx, mergebranch, targetpath, conflictchoice, username, password,
    ...
    def info(svn_url):
        ...
        return {
            ...
            'rel_url':
            entry.find('entry/relative-url').text if entry.find('entry/relative-url') is not None else "",
            'root':
...
# python3 svn_merge.py --mergeBranch svn://svn@172.16.159.129/ccb/branches/branch002 --targetPath /Users/abin/code/uw/ccb_ci_script/ccb/trunk --username svn --password svn